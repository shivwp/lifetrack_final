...
Future<ModelDailyActivityResponse> monthlyWiseData(userId, category, subCategory) async {
  ...
  await ApiBaseHelper.getInstance().post('monthly-activity-report', map);

  print ('MONTHLY GRAPH RESPONSE DATA :: '+response!.data.toString() );
  return ModelDailyActivityResponse.fromJson(response!.data);
}

Future<ModelDailyActivityResponse> monthlyWiseData01(userId) async {
